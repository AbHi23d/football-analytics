...
with c2:
    st.markdown(f'<div style="display: flex; justify-content: flex-end; align-items: center; height: 100%; margin-top: 3.5rem;"><img src="data:image/svg+xml;base64,{logo_b64}" style="width: 130px;"></div>', unsafe_allow_html=True)
